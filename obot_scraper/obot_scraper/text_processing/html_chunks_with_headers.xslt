...
<xsl:stylesheet version="1.0"
	...
	<!--a, strong, b, i, span, figure, figcaption, sub, sup, button, em|-->
	<xsl:param name="tags">div|p|h1|h2|h3|h4|h5|h6|blockquote|ol|ul|li|table|tr|th|td|pre|code|q|mark|small|abbr|label|caption|details|summary</xsl:param>
