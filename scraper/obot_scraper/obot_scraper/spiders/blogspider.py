...
class BlogspiderSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.oberlin.edu/blogs"]
    visited_urls = set()  
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if cleaned_url.startswith("https://www.oberlin.edu/blogs") and cleaned_url not in self.visited_urls:
